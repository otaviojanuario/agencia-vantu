...
export default function ProjetoInfocusCX() {
  const { t } = useLanguage();
  return (
      ...
      <main className="pt-24 md:pt-32">
        ...
        <section className="container mx-auto px-6 lg:px-24 mb-16 pt-12 md:pt-20 max-w-7xl flex flex-col md:flex-row items-start justify-between gap-12">
          ...
          <div>
            ...
            <p className="text-muted-foreground/80 mt-2 tracking-widest uppercase text-sm font-semibold">{t('projetosPage.cliente')}: InfocusCX</p>
          </div>
          ...
          <div className="text-left md:text-right flex flex-col items-start md:items-end mt-4 md:mt-0">
            ...
            <h2 className="text-3xl md:text-5xl font-sans font-semibold text-primary tracking-tighter">
              Branding
            </h2>
          </div>
        </section>
        ...
        <section className="bg-secondary text-white w-full">
          <div className="container mx-auto px-6 lg:px-24 py-20 max-w-7xl">
            <div className="max-w-4xl text-sm md:text-base lg:text-lg text-white/90 font-sans leading-relaxed space-y-6">
              <h3 className="text-2xl font-bold text-white mb-2 tracking-tight">{t('projetosPage.infocuscx.title')}</h3>
              <p>
                {t('projetosPage.infocuscx.desc')}
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="w-full bg-background pb-20 pt-10">
          {/* Layout em pilha (stacked) conforme referência do design, com alinhamento das bordas (container px-6 lg:px-24 max-w-7xl) */}
          <div className="flex flex-col w-full container mx-auto px-6 lg:px-24 max-w-7xl">

            {['01', '02', '03', '04', '05', '06', '07', '08', '10', '11', '12', '14', '15', '16'].map((id) => (
              <div key={id} className="w-full">
                <Image
                  src={`/projetos/infocuscx/images/infocusCX_Page_${id}.png`}
                  alt={`Apresentação InfocusCX página ${id}`}
